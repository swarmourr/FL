...
if __name__ == '__main__':
    ...
    for round in range(rounds):
        ...
        for clt in range(len(paths_clients)):
            ...
            tmp_eval_l={'acc':eval_results[0],'loss':float(eval_results[1]),'round':rounds,'client': paths_clients[clt].split('\\')[-1],'type':'local'}
            ...
            tmp_eval_g={'acc':eval_results[0],'loss':float(eval_results[1]),'round':rounds,'client': paths_clients[clt].split('\\')[-1],'type':'global'}
